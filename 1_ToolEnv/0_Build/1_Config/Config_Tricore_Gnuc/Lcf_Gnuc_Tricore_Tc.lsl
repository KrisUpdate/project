...
LCF_INTVEC1_START = 0x80308000;
LCF_INTVEC2_START = 0x8030A000;
LCF_INTVEC3_START = 0x8030C000;
LCF_INTVEC4_START = 0x8030E000;
LCF_INTVEC5_START = 0x80310000;
...
LCF_TRAPVEC0_START = 0x80312000;
LCF_TRAPVEC1_START = 0x80314000;
LCF_TRAPVEC2_START = 0x80316000;
LCF_TRAPVEC3_START = 0x80318000;
LCF_TRAPVEC4_START = 0x8031A000;
LCF_TRAPVEC5_START = 0x8031C000;

LCF_STARTPTR_CPU0 = 0x80000000;
LCF_STARTPTR_CPU1 = 0x8031E000;
LCF_STARTPTR_CPU2 = 0x8031F000;
LCF_STARTPTR_CPU3 = 0x80320000;
LCF_STARTPTR_CPU4 = 0x80321000;
LCF_STARTPTR_CPU5 = 0x80322000;
...
MEMORY
{
	...
	/* Added for ABMHD */
	pfls2_abmhd0 (r!p): org = 0x80604000, len = 32
	pfls2_abmhd0_nc (r!p): org = 0xa0604000, len = 32
	
	pfls2_abmhd_check_addr (r!p): org = 0x80600000, len = 32
	pfls2_abmhd_check_addr_nc (r!p): org = 0xa0600000, len = 32
...
/*Sections located at absolute fixed address*/
	...
	SECTIONS
	{		
		.abmhd_check_address (0x80600000) : FLAGS(awl)
		{
			BootModeHeader0 = .;
			KEEP (*(.abmhd_check_address))
		} > pfls2_abmhd_check_addr
	}
    ...
    SECTIONS
    {
        .traptab_tc0 (LCF_TRAPVEC0_START) : { PROVIDE(__TRAPTAB_CPU0 = .); KEEP (*(.traptab_cpu0)); } > pfls1
        ...
        .traptab_tc3 (LCF_TRAPVEC3_START) : { PROVIDE(__TRAPTAB_CPU3 = .); KEEP (*(.traptab_cpu3)); } > pfls1
        .traptab_tc4 (LCF_TRAPVEC4_START) : { PROVIDE(__TRAPTAB_CPU4 = .); KEEP (*(.traptab_cpu4)); } > pfls1
        .traptab_tc5 (LCF_TRAPVEC5_START) : { PROVIDE(__TRAPTAB_CPU5 = .); KEEP (*(.traptab_cpu5)); } > pfls1
    }
    ...
    SECTIONS
    {
        ...
        .start_tc3 (LCF_STARTPTR_CPU3) : FLAGS(rxl) { KEEP (*(.start_cpu3)); } > pfls1
        .start_tc4 (LCF_STARTPTR_CPU4) : FLAGS(rxl) { KEEP (*(.start_cpu4)); } > pfls1
        .start_tc5 (LCF_STARTPTR_CPU5) : FLAGS(rxl) { KEEP (*(.start_cpu5)); } > pfls1
	...
	/*This section defines IFW firmware version at a fixed address 0x80330000*/
	CORE_ID = GLOBAL;
	SECTIONS
	{
		.fw_version_data (0x80330000) : FLAGS(arl)
		{
