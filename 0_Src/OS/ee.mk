...
EE_IPATH= -I./0_Src/OS -I./0_Src/OS/config/inc -I./0_Src/BaseSw/Service/Tricore/Compilers -I./0_Src/OS/pkg

include 0_Src/OS/config/cfg/cfg.mk
include 0_Src/OS/kernel/oo/cfg/cfg.mk 0_Src/OS/cpu/common/cfg/cfg.mk 0_Src/OS/cpu/tricore/cfg/cfg.mk 0_Src/OS/pkg/com/com/cfg/cfg.mk
...
ifeq ($(strip $(B_GEN_TOOLCHAIN_PRIMARY_TRICORE)),Dcc)								
	$(B_GEN_TRICORE_DCC_CC) $(B_DCC_TRICORE_CC_OPTIONS) @$(B_GEN_INC_LISTFILE_TRICORE) $(EE_IPATH) -D__TC161__ -c $< -o $@ -Xmake-dependency=4 -Xmake-dependency-savefile=$(@:.o=.d)
endif
ifeq ($(strip $(B_GEN_TOOLCHAIN_PRIMARY_TRICORE)),Ghs)								
	$(B_GEN_TRICORE_GHS_CC) $(B_GHS_TRICORE_CC_OPTIONS) $< -c -D__TC161__ @$(B_GEN_INC_LISTFILE_TRICORE) $(EE_IPATH) -o $@ --make_depends
endif
