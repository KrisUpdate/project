 ...
 *
 **************************************************************************/
    #define STACK_1_SIZE 2048 /* size = 2048 bytes */
    ...
    #define STACK_6_SIZE 2048 /* size = 2048 bytes */
    #define STACK_7_SIZE 256 /* size = 256 bytes */

    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_1[EE_STACK_WLEN(STACK_1_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_1);	/* Task 0 (IFX_OSTASK_AVB_1722_TALKER) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_2[EE_STACK_WLEN(STACK_2_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_2);	/* Task 1 (IFX_OSTASK_AVB_1722_LISTENER) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_3[EE_STACK_WLEN(STACK_3_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_3);	/* Task 2 (IFX_OSTASK_EVENT1) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_4[EE_STACK_WLEN(STACK_4_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_4);	/* Task 3 (IFX_OSTASK_EVENT2) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_5[EE_STACK_WLEN(STACK_5_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_5);	/* Task 4 (IFX_OSTASK_EVENT3) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_6[EE_STACK_WLEN(STACK_6_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_6);	/* Task 13 (IFX_OSTASK_SPIROM) */
    EE_STACK_T EE_STACK_ATTRIB EE_tc_stack_7[EE_STACK_WLEN(STACK_7_SIZE)] EE_TC_FILL_STACK(EE_tc_stack_7);	/* irq stack */

    const EE_UREG EE_std_thread_tos[EE_MAX_TASK+1] = {
        0U,	/* dummy */
        1U,	/* IFX_OSTASK_AVB_1722_TALKER */
        2U,	/* IFX_OSTASK_AVB_1722_LISTENER */
        3U,	/* IFX_OSTASK_EVENT1 */
        4U,	/* IFX_OSTASK_EVENT2 */
        5U,	/* IFX_OSTASK_EVENT3 */
        0U,	/* IFX_OSTASK_1MS */
        0U,	/* IFX_OSTASK_5MS */
        0U,	/* IFX_OSTASK_10MS */
        0U,	/* IFX_OSTASK_20MS */
        ...
        0U,	/* IFX_OSTASK_INIT */
        6U 	/* IFX_OSTASK_SPIROM */
    };

    struct EE_TC_TOS EE_tc_system_tos[7] = {
        {0, 0U},	/* Task   (dummy), Task 5 (IFX_OSTASK_1MS), Task 6 (IFX_OSTASK_5MS), Task 7 (IFX_OSTASK_10MS), Task 8 (IFX_OSTASK_20MS), Task 9 (IFX_OSTASK_50MS), Task 10 (IFX_OSTASK_100MS), Task 11 (IFX_OSTASK_BACKGROUND), Task 12 (IFX_OSTASK_INIT) */
        {EE_STACK_INITP(EE_tc_stack_1), 0U},	/* Task 0 (IFX_OSTASK_AVB_1722_TALKER) */
        {EE_STACK_INITP(EE_tc_stack_2), 0U},	/* Task 1 (IFX_OSTASK_AVB_1722_LISTENER) */
        {EE_STACK_INITP(EE_tc_stack_3), 0U},	/* Task 2 (IFX_OSTASK_EVENT1) */
        {EE_STACK_INITP(EE_tc_stack_4), 0U},	/* Task 3 (IFX_OSTASK_EVENT2) */
        {EE_STACK_INITP(EE_tc_stack_5), 0U},	/* Task 4 (IFX_OSTASK_EVENT3) */
        {EE_STACK_INITP(EE_tc_stack_6), 0U} 	/* Task 13 (IFX_OSTASK_SPIROM) */
    };
 ...
 **************************************************************************/
    ...
    DeclareTask(IFX_OSTASK_AVB_1722_TALKER);
    DeclareTask(IFX_OSTASK_AVB_1722_LISTENER);
    ...
    DeclareTask(IFX_OSTASK_SPIROM);

    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub,		 /* thread IFX_OSTASK_AVB_1722_TALKER */
        &EE_oo_thread_stub,		 /* thread IFX_OSTASK_AVB_1722_LISTENER */
        ...
        &EE_oo_thread_stub 		 /* thread IFX_OSTASK_SPIROM */
    ...
    const EE_THREAD_PTR EE_terminate_real_th_body[EE_MAX_TASK] = {
        &FuncIFX_OSTASK_AVB_1722_TALKER,
        &FuncIFX_OSTASK_AVB_1722_LISTENER,
        ...
        &FuncIFX_OSTASK_INIT,
        &FuncIFX_OSTASK_SPIROM
    };
    /* ready priority */
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        0x40U,		 /* thread IFX_OSTASK_AVB_1722_TALKER */
        0x40U,		 /* thread IFX_OSTASK_AVB_1722_LISTENER */
        ...
        0x40U 		 /* thread IFX_OSTASK_SPIROM */
    };
    ...
    EE_TYPENACT EE_th_rnact[EE_MAX_TASK] = {
        1U,		 /* thread IFX_OSTASK_AVB_1722_TALKER */
        1U,		 /* thread IFX_OSTASK_AVB_1722_LISTENER */
    ...
    EE_TYPEPRIO EE_rq_link[EE_MAX_TASK] =
        { 6U, 6U, 6U, 6U, 6U, 6U, 5U, 4U, 3U, 2U, 1U, 0U, 1U, 6U};
 ...
 **************************************************************************/
    ...
    EE_TYPEPRIO EE_th_is_extended[EE_MAX_TASK] =
        { 1U, 1U, 1U, 1U, 1U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U, 0U};
