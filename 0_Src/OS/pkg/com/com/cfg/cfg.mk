...
EE_SRCS += $(EE_PKG)/pkg/com/com/src/Com.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_cominit.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_msgreception.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_filters.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_memo.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_startcom.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_stopcom.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_initmessage.c
#EE_SRCS += pkg/com/com/src/getcomapplicationmode.c
#EE_SRCS += pkg/com/com/src/comerrorgetserviceid.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_sendstatic.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_shared_send.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_receivestatic.c
EE_SRCS += $(EE_PKG)/pkg/com/com/src/ee_msgstatus.c
endif
