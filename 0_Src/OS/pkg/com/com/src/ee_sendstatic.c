...
#ifndef __PRIVATE_COM_CHECKQUEUE__
StatusType EE_com_CheckQueue(MessageIdentifier Message)
{
  return EE_com_check_queue(Message);
}
#endif

#ifndef __PRIVATE_COM_CHECKQUEUEREM__
StatusType EE_com_CheckQueueRem(MessageIdentifier Message)
{
  return EE_com_queue_rem(Message);
}
#endif
