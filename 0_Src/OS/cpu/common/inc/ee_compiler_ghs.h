...
#ifndef __INCLUDE_CPU_COMMON_EE_COMPILER_GHS__
#define __INCLUDE_CPU_COMMON_EE_COMPILER_GHS__
...
#define EE_barrier() __nop()

#endif /* __INCLUDE_CPU_COMMON_EE_COMPILER_GHS__ */
