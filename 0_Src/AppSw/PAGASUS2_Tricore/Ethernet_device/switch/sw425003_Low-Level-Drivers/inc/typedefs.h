...
/* Added the debug functions by NVIDIA */
#include <internal_fw_debug.h>

#define SJA1105_LOW_LEVEL_DRV_DEBUG_ENABLE 1

#if SJA1105_LOW_LEVEL_DRV_DEBUG_ENABLE == 1
#define SJA1105_LOW_LEVEL_DRV_DEBUG_PRINTF(x)  DEBUG_PRINTF(x)
#else
#define SJA1105_LOW_LEVEL_DRV_DEBUG_PRINTF(x)
#endif

#define SJA1105_LOW_LEVEL_DRV_ALWAYS_PRINTF(x)  DEBUG_PRINTF_ALWAYS(x)
