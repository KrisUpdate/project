...
#ifndef CONFIGURATIONISR_V3NA_H
#define CONFIGURATIONISR_V3NA_H
/******************************************************************************/
/*-----------------------------------Macros-----------------------------------*/
/******************************************************************************/
...
#define IFX_CFG_STM1_TICKS_PER_MS (10000) /**< \brief Number of STM1 ticks per millisecond */
...
#define ISR_PRIORITY_CAN_NODE6      25
#define ISR_PRIORITY_CAN_NODE7      26
...
#define ISR_PRIORITY_LIN0_RX 92        /**< \brief Define the LIN0 receive header interrupt priority.  */
#define ISR_PRIORITY_LIN1_RX 93        /**< \brief Define the LIN1 receive header interrupt priority.  */
...
#define ISR_PROVIDER_LIN0_RX 	 IfxSrc_Tos_cpu0 	/**< \brief Define the LIN0 receive header interrupt provider.  */
#define ISR_PROVIDER_LIN1_RX	 IfxSrc_Tos_cpu0 	/**< \brief Define the LIN1 receive header interrupt provider.  */
