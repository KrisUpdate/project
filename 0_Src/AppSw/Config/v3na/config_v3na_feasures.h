#ifndef CONFIG_V3NA_FEATURE
#define CONFIG_V3NA_FEATURE
...
/*
 If the RTK9068A SW1 firmware in the rom, you should define this to 1
 */
#define SKIP_RTK9068A_INIT   0
#define RTK9068A_USE_GPIO_SIM_SPI    0
...
#define CAN_NODE_A_ENABLE  1
#define CAN_NODE_B_ENABLE  1
#define CAN_NODE_C_ENABLE  1
#define CAN_NODE_D_ENABLE  1
#define CAN_NODE_E_ENABLE  1
#define CAN_NODE_F_ENABLE  1
#define CAN_NODE_G_ENABLE  1
#define CAN_NODE_H_ENABLE  1
...
/* Ethernet OTA enable */
#define ETHERNET_OTA_ENABLE     0       // Disable
#define _OTA_PROD_FW            0x01
#define _OTA_UPDATE_FW          0x02
#define ETHERNET_OTA_FW_TYPE    0       // Skip FW
...
/* Set LIN mode */
#define FEATURE_FIXTURE_LIN_SLAVE 0
#define TE_DVT_100M 0
#endif
