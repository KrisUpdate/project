...
#ifndef CONFIGURATIONISR_V3AA_H
#define CONFIGURATIONISR_V3AA_H
/******************************************************************************/
/*-----------------------------------Macros-----------------------------------*/
/******************************************************************************/
...
#define ISR_PRIORITY_QSPI2_TX       50  /**< \brief Define the Qspi2 transmit interrupt priority.  */
#define ISR_PRIORITY_QSPI2_RX       51  /**< \brief Define the Qspi2 receive interrupt priority.  */
...
#define ISR_PRIORITY_BMC_UART_RX    68
#define ISR_PRIORITY_BMC_UART_TX    69
#define ISR_PRIORITY_BMC_UART_ERR   70
