...
void IfxSent_Sent_initChannelConfig(IfxSent_Sent_ChannelConfig *config, IfxSent_Sent *driver)
{
    const IfxSent_Sent_ChannelConfig defaultChannelConfig = {
        ...
        .receiveControl.frequencyDriftCheckEnabled                = FALSE,
        ...
        .interuptNodeControl.receiveDataInterruptNode             = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.receiveSuccessInterruptNode          = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.receiveBufferOverflowInterruptNode   = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.transferDataInterruptNode            = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.transferBufferUnderflowInterruptNode = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.errorInterruptNode                   = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.serialDataReceiveInterruptNode       = IfxSent_InterruptNodePointer_trigo0,
        .interuptNodeControl.watchdogErrorInterruptNode           = IfxSent_InterruptNodePointer_trigo0,
