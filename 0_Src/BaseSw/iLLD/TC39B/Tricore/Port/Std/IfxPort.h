...
IFX_INLINE uint8 IfxPort_getPinDirection(Ifx_P *port, uint8 pinIndex);
...
IFX_EXTERN uint8 IfxPort_getPinDir(Ifx_P *port, uint8 pinIndex);
...
IFX_INLINE uint8 IfxPort_getPinDirection(Ifx_P *port, uint8 pinIndex)
{
    return IfxPort_getPinDir(port, pinIndex);
