...
void IfxGeth_mtl_enableTxQueue(Ifx_GETH *gethSFR, IfxGeth_TxMtlQueue queueId)
{
    ...
    case IfxGeth_TxMtlQueue_1:
        gethSFR->MTL_TXQ1.OPERATION_MODE.B.TXQEN = 1;
        break;
    case IfxGeth_TxMtlQueue_2:
        gethSFR->MTL_TXQ2.OPERATION_MODE.B.TXQEN = 1;
        break;
    case IfxGeth_TxMtlQueue_3:
        gethSFR->MTL_TXQ3.OPERATION_MODE.B.TXQEN = 1;
        break;
#else
    case IfxGeth_TxMtlQueue_1:
...
void IfxGeth_mtl_setTxETSControl(Ifx_GETH *gethSFR, IfxGeth_TxMtlQueue queueId)
{
    switch (queueId)
    {
    case IfxGeth_TxMtlQueue_1:
        gethSFR->MTL_TXQ1.ETS_CONTROL.B.AVALG = 1;
        gethSFR->MTL_TXQ1.ETS_CONTROL.B.CC = 1;
        break;
    case IfxGeth_TxMtlQueue_2:
        gethSFR->MTL_TXQ2.ETS_CONTROL.B.AVALG = 1;
        gethSFR->MTL_TXQ2.ETS_CONTROL.B.CC = 1;
        break;
    case IfxGeth_TxMtlQueue_3:
        gethSFR->MTL_TXQ3.ETS_CONTROL.B.AVALG= 1;
        gethSFR->MTL_TXQ3.ETS_CONTROL.B.CC = 1;
        break;
    }
}

void IfxGeth_mtl_setTxCreditParam(Ifx_GETH *gethSFR, IfxGeth_TxMtlQueue queueId)
{
    switch (queueId)
    {
    case IfxGeth_TxMtlQueue_1:
        gethSFR->MTL_TXQ1.QUANTUM_WEIGHT.B.ISCQW = 2867;
        gethSFR->MTL_TXQ1.SENDSLOPECREDIT.B.SSC = 1229;
        gethSFR->MTL_TXQ1.HICREDIT.B.HC = 12288000;
        gethSFR->MTL_TXQ1.LOCREDIT.B.LC = 0x102F7000;
        break;
    case IfxGeth_TxMtlQueue_2:
        gethSFR->MTL_TXQ2.QUANTUM_WEIGHT.B.ISCQW = 2867;
        gethSFR->MTL_TXQ2.SENDSLOPECREDIT.B.SSC = 1229;
        gethSFR->MTL_TXQ2.HICREDIT.B.HC = 12288000;
        gethSFR->MTL_TXQ2.LOCREDIT.B.LC = 0x102F7000;
        break;
    case IfxGeth_TxMtlQueue_3:
        gethSFR->MTL_TXQ3.QUANTUM_WEIGHT.B.ISCQW = 2867;
        gethSFR->MTL_TXQ3.SENDSLOPECREDIT.B.SSC = 1229;
        gethSFR->MTL_TXQ3.HICREDIT.B.HC = 12288000;
        gethSFR->MTL_TXQ3.LOCREDIT.B.LC = 0x102F7000;
        break;
    }
}
