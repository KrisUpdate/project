...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gvlnGetPortVid != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtGetForceDefaultVid(dev, portNum, en);
	else
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gvlnSetPortVid != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtSetForceDefaultVid(dev, portNum, en);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtSetEgressMode != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtSetEgressMode(dev, portNum, mode);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtGetEgressMode != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtGetEgressMode(dev, portNum, mode);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtSetPortECID != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtSetPortECID(dev, portNum, ecid);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtGetPortECID != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtGetPortECID(dev, portNum, ecid);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtSetIgnoreETag != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtSetIgnoreETag(dev, portNum, en);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtGetIgnoreETag != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtGetIgnoreETag(dev, portNum, en);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtSetExtendedPortCtrlReg != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtSetExtendedPortCtrlReg(dev, portNum, index, fieldOffset, fieldLength, data);
	else
		return MSD_NOT_SUPPORTED;
}
...
)
{
	...
	if (dev->SwitchDevObj.PORTCTRLObj.gprtGetExtendedPortCtrlReg != NULL)
		return dev->SwitchDevObj.PORTCTRLObj.gprtGetExtendedPortCtrlReg(dev, portNum, index, fieldOffset, fieldLength, data);
	else
		return MSD_NOT_SUPPORTED;
}
