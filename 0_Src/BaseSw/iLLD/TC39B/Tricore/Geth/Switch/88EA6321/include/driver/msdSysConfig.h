...
#define MAX_SOHO_DEVICES	8//32
#define MAX_RMU_TO_BUFFER   32
/*
...
typedef enum
{
    ...
    MSD_88Q5050  = 0xA51    /* 88Q5050 automotive switch, Full Featured Device*/
...
typedef MSD_STATUS(*FMSD_gprtSetExtendedPortCtrlReg)(MSD_QD_DEV*  dev, MSD_LPORT, MSD_U8 index, MSD_U8 fieldOffset, MSD_U8 fieldLength, MSD_U16 data);
typedef MSD_STATUS(*FMSD_gprtGetExtendedPortCtrlReg)(MSD_QD_DEV*  dev, MSD_LPORT, MSD_U8 index, MSD_U8 fieldOffset, MSD_U8 fieldLength, MSD_U16 *data);
...
typedef struct
{
	...
	_SwitchDevTCAMRCObj TCAMRCObj;
	_SwitchDevTCAMRCCompObj TCAMRCCompObj;
	_SwitchDevARPObj ARPObj;
 ...
 *   accessMode     - current RMU access mode (currently only supported by Willow)
...
struct _MSD_QD_DEV
{
    ...
    /*RMU buffering*/
    MSD_U8       accessMode;
    MSD_RegCmd   regCmdBuffer[MAX_RMU_TO_BUFFER];
    MSD_U16      *regCmdResultPtr[MAX_RMU_TO_BUFFER];
    MSD_U32      nCmdBufferLevel;
    MSD_U32      nCmdBufferFlushLevel;
    MSD_U8       phyAddr;
