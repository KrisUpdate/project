...
)
{
	...
	*/
    ...
    dev->baseRegAddr = cfg->baseRegAddr;//PEARL_PORT_START_ADDR+5; //port 5
    ...
    while (flag)
	{
        ...
        switch (dev->deviceId)
        {
		    ...
		    case MSD_88E6341:
                    ...
                    break;        
            case MSD_88Q5050:  /*by Leo, Copy from MSD_88E6341, need to check the parameters*/
            case 0:            /*first revision of Willow with id 0*/
                    dev->numOfPorts = 9;
                    dev->maxPorts = 9;
                    dev->maxPhyNum = 5;
                    dev->validPortVec = (1 << dev->numOfPorts) - 1;
                    ...
                    dev->validPhyVec = 0x1E;
                    dev->validSerdesVec = 0x20;
                    dev->basePhyRegAddr = 0x0;
                    dev->devName = MSD_WILLOW; /*keep use TOPAZ api */
                    break;
...
{
    MSD_U8    phyAddr = (MSD_U8)MSD_INVALID_PHY;
