...
#ifndef __Willow_msdQueueCtrl_h
#define __Willow_msdQueueCtrl_h
...
#define WILLOW_MAX_QOS_WEIGHTS        128

/*
*  typedef: enum WILLOW_MSD_PORT_SCHED_MODE
*
*  Description: Enumeration of port scheduling mode
*
*  Fields:
*
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI7_6_5_4_3_2_1_0 - use 33,25,17,12,6,3,2,1 weighted fair
*										scheduling
*	       WILLOW_MSD_PORT_SCHED_WRR_PRI6_5_4_3_2_1_0 - use a strict for priority 7 and weighted
*										round robin for priorities 6,5,4,3,2,1 and 0
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI5_4_3_2_1_0 - use a strict for priority 7,6 and weighted
*										round robin for priorities 5,4,3,2,1 and 0
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI4_3_2_1_0 - use a strict for priority 7,6,5 and weighted
*										round robin for priorities 4,3,2,1 and 0
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI3_2_1_0 - use a strict for priority 7,6,5,4 and
*										weighted round robin for priorities 3,2,1 and 0
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI2_1_0 - use a strict for priority 7,6,5,4,3 and
*										weighted round robin for priorities 2,1 and 0
*		   WILLOW_MSD_PORT_SCHED_WRR_PRI1_0 - use a strict for priority 7,6,5,4,3,2
*										and weighted round robin for priorities 1 and 0
*		   WILLOW_MSD_PORT_SCHED_STRICT_PRI_ALL - use a strict priority scheme for all priorities
*
*  Comment:
*/
typedef enum
{
    WILLOW_MSD_PORT_SCHED_WRR_PRI7_6_5_4_3_2_1_0 = 0x0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI6_5_4_3_2_1_0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI5_4_3_2_1_0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI4_3_2_1_0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI3_2_1_0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI2_1_0,
    WILLOW_MSD_PORT_SCHED_WRR_PRI1_0,
    WILLOW_MSD_PORT_SCHED_STRICT_PRI_ALL
} WILLOW_MSD_PORT_SCHED_MODE;
...
{
    MSD_U32        len;
    MSD_U8         queue[WILLOW_MAX_QOS_WEIGHTS];
}WILLOW_MSD_QoS_WEIGHT;
...
MSD_STATUS Willow_gprtSetQueueCtrlIntf
(
IN  MSD_QD_DEV         *dev,
IN  MSD_LPORT          port,
IN  MSD_U8             point,
...
MSD_STATUS Willow_gprtGetQueueCtrlIntf
(
IN  MSD_QD_DEV         *dev,
IN  MSD_LPORT          port,
IN  MSD_U8             point,
...
MSD_STATUS Willow_gprtSetPortSchedIntf
(
IN  MSD_QD_DEV    *dev,
IN  MSD_LPORT     port,
...
MSD_STATUS Willow_gprtGetPortSchedIntf
(
IN  MSD_QD_DEV    *dev,
IN  MSD_LPORT     port,
...
*
******************************************************************************/
MSD_STATUS Willow_gsysSetQoSWeightIntf
(
IN  MSD_QD_DEV        *dev,
...
*
******************************************************************************/
MSD_STATUS Willow_gsysGetQoSWeightIntf
(
IN  MSD_QD_DEV         *dev,
