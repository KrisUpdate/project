...
#define MSD_RMU_WAIT_ON_BIT_VAL1 3
    ...
    /*
	* Typedef: enum MSD_REGISTER_ACCESS_MODE
	*
	* Description: Defines access mode for Registers using RMU functions
	*
	* Fields:
	*      MSD_RMU_ACCESS_MODE_SYNCHRONOUS - synchronous mode (default)
	*      MSD_RMU_ACCESS_MODE_ASYNCHRONOUS - synchronous mode (default)
	*      MSD_RMU_ACCESS_MODE_CRITICAL - synchronous mode (default)
	*/
	typedef enum
	{
		MSD_RMU_ACCESS_MODE_SYNCHRONOUS = 0x0,
		MSD_RMU_ACCESS_MODE_ASYNCHRONOUS = 0x1,
		MSD_RMU_ACCESS_MODE_CRITICAL = 0x2
	} MSD_REGISTER_ACCESS_MODE;
