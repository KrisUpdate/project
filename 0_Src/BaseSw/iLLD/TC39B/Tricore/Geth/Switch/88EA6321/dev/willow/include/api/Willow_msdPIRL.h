...
#ifndef __Willow_msdPIRL_h
#define __Willow_msdPIRL_h
...
/*
 *  typedef: enum WILLOW_MSD_PIRL_COUNT_MODE
 *
...
typedef enum
{
    WILLOW_MSD_PIRL_COUNT_FRAME = 0,
    WILLOW_MSD_PIRL_COUNT_ALL_LAYER1,
    WILLOW_MSD_PIRL_COUNT_ALL_LAYER2,
    WILLOW_MSD_PIRL_COUNT_ALL_LAYER3
} WILLOW_MSD_PIRL_COUNT_MODE;

/*
 *  typedef: struct WILLOW_MSD_PIRL_CUSTOM_RATE_LIMIT
 *
 ...
 *      				    WILLOW_MSD_PIRL2_COUNT_FRAME,
 *                 		    WILLOW_MSD_PIRL2_COUNT_ALL_LAYER1,
 *          			    WILLOW_MSD_PIRL2_COUNT_ALL_LAYER2, or
 *            			    WILLOW_MSD_PIRL2_COUNT_ALL_LAYER3
*/
typedef struct
{
    MSD_BOOL       isValid;
    ...
    /*Count Mode*/
    WILLOW_MSD_PIRL_COUNT_MODE       countMode;

} WILLOW_MSD_PIRL_CUSTOM_RATE_LIMIT;

/*
 *  typedef: enum WILLOW_MSD_PIRL_FC_DEASSERT
 *
 *  Description: Enumeration of the port flow control de-assertion mode on PIRL.
 *
 *  Enumerations:
 *      WILLOW_MSD_PIRL_FC_DEASSERT_EMPTY -
 *                De-assert when the ingress rate resource has become empty
 *        WILLOW_MSD_PIRL_FC_DEASSERT_CBS_LIMIT -
 *                De-assert when the ingress rate resource has enough room as
 *                specified by the CBSLimit.
 */
typedef enum
{
    WILLOW_MSD_PIRL_FC_DEASSERT_EMPTY = 0,
    WILLOW_MSD_PIRL_FC_DEASSERT_CBS_LIMIT
} WILLOW_MSD_PIRL_FC_DEASSERT;

/*
 * Typedef: enum WILLOW_MSD_PIRL_ACTION
 *
 ...
 *
 * Fields:
 *        Willow_PIRL_ACTION_ACCEPT - accept the frame
 *        Willow_PIRL_ACTION_USE_LIMIT_ACTION - use EBS Limit Action
 */
typedef enum
{
    Willow_PIRL_ACTION_USE_LIMIT_ACTION = 0x0,
    Willow_PIRL_ACTION_ACCEPT     = 0x1
} WILLOW_MSD_PIRL_ACTION;


/*
 * Typedef: enum WILLOW_MSD_EBS_LIMIT_ACTION
 *
 ...
 *
 * Fields:
 *        Willow_EBS_LIMIT_ACTION_DROP - drop packets
 *        Willow_EBS_LIMIT_ACTION_FC   - send flow control packet
 */
typedef enum
{
    Willow_EBS_LIMIT_ACTION_DROP     = 0x0,
    Willow_EBS_LIMIT_ACTION_FC       = 0x1
} WILLOW_MSD_EBS_LIMIT_ACTION;

/*
 *  typedef: struct WILLOW_MSD_PIRL_DATA
 *
...
*      mgntNrlEn   -Account MGMT frame or not
*      saAVBNrlEn   -Account SA AVB frame or not
*      daAVBNrlEn   -Account DA AVB frame or not
 ...
 *                                Willow_PIRL_ACTION_ACCEPT - accept the frame
 *                                Willow_PIRL_ACTION_USE_LIMIT_ACTION - use limitAction
...
typedef struct
{
	...
	/*flow control*/
    WILLOW_MSD_PIRL_FC_DEASSERT		fcMode;
    WILLOW_MSD_PIRL_ACTION    actionMode;
    WILLOW_MSD_EBS_LIMIT_ACTION ebsLimitAction;
	
	/*customer setup*/
	WILLOW_MSD_PIRL_CUSTOM_RATE_LIMIT customSetup;

} WILLOW_MSD_PIRL_DATA;
/****************************************************************************/
