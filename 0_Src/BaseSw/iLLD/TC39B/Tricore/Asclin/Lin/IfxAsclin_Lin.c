...
IfxAsclin_Status IfxAsclin_Lin_initModule(IfxAsclin_Lin *asclin, const IfxAsclin_Lin_Config *config)
{
    ...
    IfxAsclin_enableTxFifoOutlet(asclinSFR, FALSE);         /* disabling Tx FIFO for transmitting*/
    IfxAsclin_enableRxFifoInlet(asclinSFR, FALSE);          /* disabling Rx FIFO for recieving*/
