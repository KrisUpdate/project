...
const IfxMtu_SramItem           IfxMtu_sramTable[IFXMTU_NUM_MBIST_TABLE_ITEMS] = {
    ...
    {0 * 0, 0,   0,  0, 0}, /**< \brief IfxMtu_MbistSel_none */
    {0 * 0, 0,   0,  0, 0}, /**< \brief IfxMtu_MbistSel_none */
    {1 * 2, 64,  8,  0, 1}, /**< \brief IfxMtu_MbistSel_mod50 */
    {1 * 2, 64,  8,  0, 1}, /**< \brief IfxMtu_MbistSel_mod51 */
    {2 * 1, 64,  8,  0, 1}, /**< \brief IfxMtu_MbistSel_mod4 */
    ...
    {1 * 4, 32,  7,  0, 1}, /**< \brief IfxMtu_MbistSel_mod1 */
    {1 * 4, 24,  6,  0, 1}, /**< \brief IfxMtu_MbistSel_mod2 */
    {1 * 3, 128, 9,  0, 1}, /**< \brief IfxMtu_MbistSel_mod3 */
    {1 * 1, 64,  8,  0, 1}, /**< \brief IfxMtu_MbistSel_mod6 */
    {1 * 1, 64,  8,  0, 1}, /**< \brief IfxMtu_MbistSel_mod7 */
