...
int main(int argc, char **argv){
        ...
        int ndata = 26;   /* the number of file data */
        char data[26] = {0x14,0x03,0x01,0x00,0x14,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x08,0x00,0x78,0x56,0x34,0x12,0xab,0xcd,0xef,0xaa};
